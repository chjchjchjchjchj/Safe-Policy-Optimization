...
if __name__ == "__main__":
    ...
    # ipdb.set_trace()
    # print(f"args={args}")
    # print(f"cfg_env={cfg_env}")
    # sys.exit()
    from argparse import Namespace
    args=Namespace(cost_limit=25.0, device='cpu', device_id=0, experiment='single_agent_exp', headless=False, lagrangian_multiplier_init=0.001, lagrangian_multiplier_lr=0.035, log_dir='../runs/single_agent_exp/SafetyPointGoal1-v0/ppo_lag/seed-000-2024-07-06-22-17-08', num_envs=10, randomize=False, seed=0, steps_per_epoch=20000, task='SafetyPointGoal1-v0', total_steps=10000000, use_eval=False, write_terminal=True)
